            ...
            <form action="{{ route('categorias') }}" method="get">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        ...
                        <a class="btn btn-success" href="{{ route('categoria.create') }}"><i class="fas fa-plus"></i> Crear Nuevo</a>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <td class="text-right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li><a class="dropdown-item" href="{{ route('categoria.show',$item->id) }}"><i class="fas fa-eye"></i> Ver</a></li>
                                <li><a class="dropdown-item" href="{{ route('categoria.edit',$item->id) }}"><i class="fas fa-edit"></i> Editar</a></li>
